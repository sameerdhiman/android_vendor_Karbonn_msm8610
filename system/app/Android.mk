...
include $(CLEAR_VARS)
LOCAL_MODULE := CarrierLoadService
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := CarrierLoadService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := com.qualcomm.msapm.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := GsmTuneAway.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := InterfacePermissions.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := ModemTestMode.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := QComQMIPermissions.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := $(COMMON_ANDROID_PACKAGE_SUFFIX)
include $(BUILD_PREBUILT)
